...
def preprocess_data():
    ...
    for folder in os.listdir(raw_data_dir): 
        ...
        if os.path.join(raw_data_dir, folder) != os.path.join(raw_data_dir, "temp"):
            ...
            output_path = os.path.join(script_dir, "..", "..", "Data", "temp", f"preprocessed_{folder}")  # output path for preprocessed files with a prefix in the temp directory, forwarded to Preprocessing.py
